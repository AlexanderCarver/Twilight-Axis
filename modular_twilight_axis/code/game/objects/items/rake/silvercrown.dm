...
/obj/item/clothing/head/roguetown/crown/silvercrown
	...
	icon = 'modular_twilight_axis/icons/rake/clothing/silvercrown.dmi'
	mob_overlay_icon = 'modular_twilight_axis/icons/rake/clothing/onmob/silvercrown.dmi'
...
/obj/item/clothing/head/roguetown/crown/silvercrown/process()
	...
	for(var/mob/living/carbon/human/H in GLOB.player_list)
		if(H.ckey == "greenrake" && H.mind?.assigned_role == "Lord")
			lord_found = TRUE
			break
